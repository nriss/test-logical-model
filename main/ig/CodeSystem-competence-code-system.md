# Compétences CodeSystem - Test - Héritage de Modèles Logiques v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/fhir/test-logical-model/CodeSystem/competence-code-system | *Version*:0.1.0 |
| Draft as of 2026-03-27 | *Computable Name*:CompetenceCS |
...
```json
{
  ...
  "url" : "https://interop.esante.gouv.fr/ig/fhir/test-logical-model/CodeSystem/competence-code-system",
  "version" : "0.1.0",
  "name" : "CompetenceCS",
